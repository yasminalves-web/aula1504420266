...
![Diagrama de Classes](https://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/SEU_USER/SEU_REPO/main/docs/diagrams/fitpass_class_diagram.puml)

> **Substitua** `SEU_USER/SEU_REPO` pelo caminho real do seu repositório.
